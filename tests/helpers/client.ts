...
const COMM_BASE   = process.env.SF1_COMM_BASE   || 'http://172.17.0.27:3005';
const JOURN_BASE  = process.env.SF1_JOURN_BASE  || 'http://172.17.0.8:3003';
const MEDIA_BASE  = process.env.SF1_MEDIA_BASE  || 'http://172.17.0.19:3008';
const PRICE_BASE  = process.env.SF1_PRICE_BASE  || 'http://172.17.0.18:3002';
const GAM_BASE    = process.env.SF1_GAM_BASE    || 'http://172.17.0.16:3009';
const SEARCH_BASE = process.env.SF1_SEARCH_BASE || 'http://172.17.0.14:3007';
const BACKUP_BASE = process.env.SF1_BACKUP_BASE || 'http://172.17.0.21:3011';
const TOOLS_BASE  = process.env.SF1_TOOLS_BASE  || 'http://172.17.0.23:3004';
const AI_BASE     = process.env.SF1_AI_BASE     || 'http://0.0.0.0:3010';
const NOTIF_BASE  = process.env.SF1_NOTIF_BASE  || 'http://172.17.0.25:3006';
